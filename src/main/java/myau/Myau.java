...
public class Myau {
    ...
    public void init() {
        ...
        moduleManager.modules.put(ChatLimitRemove.class, new ChatLimitRemove());
        ...
        moduleManager.modules.put(Regen.class, new Regen());
        ...
        // Property registration and event binding
