...
public class ClickGui extends GuiScreen {
    ...
    public ClickGui() {
        ...
        movementModules.add(Myau.moduleManager.getModule(Freecam.class));
        ...
        renderModules.add(Myau.moduleManager.getModule(FovFix.class));
        ...
        renderModules.add(Myau.moduleManager.getModule(RearView.class));
